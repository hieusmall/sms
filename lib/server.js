...
server.processHandlerResponse = function(res,method,trimmedPath,statusCode,payload,contentType,headers){
    ...
    if (headers !== undefined) {
        var headers = typeof (headers) == "object" && headers instanceof Object && Object.keys(headers).length > 0 ? headers : false;
        if (headers) {
...
server.router = {
    ...
    'api/testSms' : handlers.checkConnection,
    'api/sms' : handlers.sms,
